...
!(function () {
  console.log('global again Objects', JSON.stringify(Object.keys(window)))
  // console.log("global again",window.useArkoseSetupEnforcement)
  var e = {
      6857: function (e, t) {
        'use strict'
        t.N = void 0
      ...
      2585: function (e, t, n) {
        ...
        function Me(e, t) {
          var n,
            ...
            i = e.__data__
          return (
            'string' == (o = r((n = t))) || 'number' == o || 'symbol' == o || 'boolean' == o
              ? '__proto__' !== n
              : null === n
          )
  ...
  !(function () {
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                this.config.publicKey !== e &&
                  ...
                  Y(window, this.config.publicKey)
                var i = window[R][this.config.publicKey].listener
                i && window.removeEventListener('message', i),
                  ee(window, this.config.publicKey, 'listener', this.messageListener),
                  window.addEventListener('message', window[R][this.config.publicKey].listener)
              },
            },
            {
              key: 'postMessage',
    ...
    var Ne = {
        ...
        return (
          Object.keys(i).forEach(function (e) {
            Object.prototype.hasOwnProperty.call(r, e)
              ? (o[e] = r[e])
              : !0 !== Ne[e].optional && (o[e] = Ne[e].default)
          }),
          o
        )
      },
      ...
      Ue = n(3482),
      Ge = {}
    ;(Ge.styleTagTransform = We()),
      (Ge.setAttributes = qe()),
      (Ge.insert = Me().bind(null, 'head')),
      (Ge.domAPI = De()),
      (Ge.insertStyleElement = ze())
    Ie()(Ue.Z, Ge)
    ...
    Pe.on('challenge iframe', function (e) {
      ...
      if (Je.frame) {
        ...
        var p = !1
        t && t !== Je.frame.style.width && ((Je.frame.style.width = t), (p = !0)),
          n && n !== Je.frame.style.height && ((Je.frame.style.height = n), (p = !0)),
          Je.mode === a &&
            (r &&
              r !== Je.frame.style['min-width'] &&
              ((Je.frame.style['min-width'] = r), (p = !0)),
            o &&
              o !== Je.frame.style['min-height'] &&
              ((Je.frame.style['min-height'] = o), (p = !0)),
            i && i !== Je.frame.style['max-width'] && ((Je.frame.style['max-width'] = i), (p = !0)),
            c &&
              c !== Je.frame.style['max-height'] &&
              ((Je.frame.style['max-height'] = c), (p = !0))),
          p &&
            Pe.emit(O, {
              width: l,
              height: u,
    ...
    var ut = $.key,
      ...
      pt = (function (e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 5e3,
          ...
          j = function (e) {
            return y && Object.prototype.hasOwnProperty.call(y, ''.concat(e, 'Threshold'))
                ...
                (function () {
                  ...
                  return Object.keys(le).reduce(function (t, n) {
                    var r = e[n],
                      o = le[n]
                    if ('boolean' === o.type)
                      return oe(oe({}, t), {}, ae({}, n, 'boolean' == typeof r ? r : o.default))
    ...
    var dt = function (e) {
      ...
      Tt = function () {
        !(function (e) {
          ...
          ;(Je.mode = u),
            ...
            (Je.isActive = i),
            (Je.show = a),
            (Je.ECResponsive = B(Re(o.settings), 'ECResponsive', {})),
            (Je.accessibilitySettings = B(o, 'accessibilitySettings'))
          var l = Ye()
          if (B(Je.element, 'children', []).length < 1) {
            ...
            p.setAttribute(
              ...
              s.subTimerStart(L, F),
              Je.element.appendChild(p),
              (Je.frame = p)
          } else
            Qe(Je.frame, l),
              Je.isActive || ((Je.frame.style.width = 0), (Je.frame.style.height = 0))
        })({
          host: lt,
      ...
      It = function () {
        ...
        ;(vt.isActive = !1),
          e && (vt.isHidden = !0),
          Ct(l, new kt(vt)),
          vt.savedActiveElement && (vt.savedActiveElement.focus(), (vt.savedActiveElement = null)),
          B(vt, 'config.mode') !== a &&
            (function () {
              for (var e = vt.modifiedSiblings, t = 0; t < e.length; t += 1) {
                var n = e[t],
                  ...
                  o = n.ariaHiddenState
                r !== vt.appEl &&
                  (null === o ? r.removeAttribute('aria-hidden') : r.setAttribute('aria-hidden', o))
              }
            })(),
          Tt(),
          Rt(!0)
      ...
      Ft = function () {
        return B(vt, 'config.mode') === a
          ? ((vt.container = document.querySelector(B(vt, 'config.selector', ''))),
            void (
              vt.container &&
              (vt.container.contains(vt.element) || (vt.container.appendChild(vt.element), Tt()))
            ))
          : ((vt.container = vt.bodyElement),
            vt.events.bodyClicked ||
              ((vt.events.bodyClicked = Kt),
              vt.bodyElement.addEventListener('click', vt.events.bodyClicked)),
            vt.events.escapePressed ||
              ((vt.events.escapePressed = Dt),
      ...
      Mt = function () {
        ...
        pt.subTimerEnd(L, D),
          Y(window, ut),
          Pe.setup(ut, A),
          (e = window[R][ut].error) && window.removeEventListener('error', e),
          ee(window, ut, 'error', function (e) {
            var t = e.message,
              n = e.filename,
              r = e.error
          ...
          window.addEventListener('error', window[R][ut].error),
          (vt = Pt())
      },
      Ht = function () {
        var e,
        ...
        t.publicKey &&
            ...
            Pe.setup(e, A),
              ...
              vt.element &&
                ...
                (vt.element.getAttribute('class').match(e) ||
                  vt.element.setAttribute('class', dt(e)))
          })(t.publicKey),
          (i = t.publicKey),
          vt.config.publicKey && vt.config.publicKey !== t.publicKey && (c = !0)),
          (vt.config = ot(
            ot(ot(ot({}, vt.config), t), {
              mode: n,
            }),
            {},
            {
          ...
          (vt.events = ot(
            ot({}, vt.events),
            {},
            (ct((e = {}), yt, t[yt] || vt.events[yt]),
            ct(e, St, t[St] || vt.events[St]),
            ct(e, ht, t[ht] || vt.events[ht]),
            ct(e, mt, t[mt] || vt.events[mt]),
            ct(e, bt, t[bt] || vt.events[bt]),
            ct(e, gt, t[gt] || vt.events[gt]),
            ct(e, wt, t[wt] || vt.events[wt]),
            ct(e, Ot, t[Ot] || vt.events[Ot]),
            ct(e, jt, t[jt] || vt.events[jt]),
            ct(e, xt, t[xt] || vt.events[xt]),
            ct(e, Et, t[Et] || vt.events[Et]),
            e),
          )),
          Pe.emit('config', vt.config),
          o || c ? Nt(!0) : Ft(),
          'lightbox' === n &&
            (vt.element.setAttribute('aria-modal', !0), vt.element.setAttribute('role', 'dialog'))
      },
      qt = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          t = e.event,
        ...
        ;(function (e, t) {
          ...
          return o
        })(a, vt.onReadyEventCheck).length === a.length &&
          ((vt.enforcementReady = !0),
          (vt.onReadyEventCheck = []),
          vt.isCompleteReset || (pt.timerEnd(L), Ct(f, new kt(vt))),
    ...
    Pe.on(w, function () {
      vt.isReady || (pt.timerStart(I), pt.timerStart(K)),
        (vt.isActive = !0),
      ...
      Pe.on(x, function (e) {
        ...
        ;(vt.isReady = !0),
          (vt.token = t),
          vt.isHidden || ((vt.isActive = !0), Tt(), pt.timerEnd(I), Ct(h, new kt(vt)))
      }),
      Pe.on('challenge completed', function () {
        ...
        ;(vt.completed = !0),
          ...
          pt.timerEnd(K),
          Ct(u, new kt(vt)),
          B(vt, 'config.mode') !== a && ((vt.isCompleteReset = !0), Nt())
      }),
      Pe.on('hide enforcement', It),
      Pe.on(O, function (e) {
        var t = e.width,
          n = e.height
      ...
      Pe.on(E, qt),
      Pe.on('challenge token', function (e) {
        var t = e.token
        if (t) {
          vt.token = t
          var n = t.split('|'),
