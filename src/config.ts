...
export const Prompt =
  'First summarise the story of the following into a short problem statement(just focus on mathematical part while summarizing and ignore the proper nouns and story around them).\
